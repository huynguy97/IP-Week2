...
void verify_direction_or_end_trail()
{
...
void fill_cave_with_balls (bool ok)
{
    //                                                                             
    if(ok)
    {
