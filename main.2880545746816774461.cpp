...
{
    //                                                                                        
    bool charlesfillscave = true;
    if(!in_front_of_wall())
    {
        step();
        turn_right();
    }
    while(charlesfillscave)
    {
        while(!on_ball() && charlesfillscave)
        {
            if(!in_front_of_wall())
            {
                put_ball();
    ...
    turn_right();
	while (!in_front_of_wall() && !charlesfillscave)
    {
        step();
        if (in_front_of_wall())
        {
            turn_right();
            charlesfillscave = true;
        }
    }
}
//                                                                       
