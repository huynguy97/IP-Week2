...
//                                                                
//                                                                                                                                                                             
void balls_worldborder_to_caveborder ()
{
    if (!in_front_of_wall())
    {
 ...
 //                                                             
 //                                                                                                              
 void balls_caveborder_to_worldborder ()
{
    turn_left();
...
void fill_cave_with_balls ()
{
    ...
    balls_worldborder_to_caveborder();
    balls_caveborder_to_worldborder();
