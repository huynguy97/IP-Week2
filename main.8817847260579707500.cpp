...
void set_dir(std::string direction){
    while(!north()){
        turn_left();
    }
    if(direction=="east")turn_right();
    if(direction=="west")turn_left();
    if(direction=="south")turn_around();
}
//                                                                                                                                             
bool done;
void find_left_corner(){
    //                                                                                                                    
    turn_left();
    if(in_front_of_wall()){
        //                                                                   
