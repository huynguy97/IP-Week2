...
//                                                               
void fill_lines_with_balls()
{
    while (!in_front_of_wall())
        fill_line_with_balls();
}
